            ...
            try {
                ...
                switch(msg.getType()){
                    ...
                    case SUBMIT_ACK:
                        ...
                        botInputQ.put(new MemeBotMsg3000().type(Send_User).body(msg.getMessage()).user(msg.getUsername()).userID(msg.getUserID()));
                        break;
                    ...
                    case CURATE_RESULT:
                        ...
                        botInputQ.put(new MemeBotMsg3000().type(Send_User).body(msg.getLink()).userID(msg.getUserID()).user(msg.getUsername()));
                        botInputQ.put(new MemeBotMsg3000().type(Send_User).body(msg.getMessage()).user(msg.getUsername()).userID(msg.getUserID()));
                    ...
                    case MEME:
                        ...
                        botInputQ.put(new MemeBotMsg3000().type(Send_Channel).body(msg.getLink()).user(msg.getUsername()).userID(msg.getUserID()).channelID(msg.getChannelID()));
                        break;

                    case ERROR:
                    	logger.println(level.ERROR, msg.getMessage() + msg.getTags());
                        botInputQ.put(new MemeBotMsg3000().type(Send_User).body(msg.getMessage() + msg.getTags()).user(msg.getUsername()).userID(msg.getUserID()));
                        break;
